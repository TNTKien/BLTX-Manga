  ...
  return (
    <div className="space-y-2">
      {/* <div className="inline-flex p-1 items-center rounded-md bg-primary-foreground">
        ...
        <p className="px-3 py-1.5 text-muted-foreground">Lượt theo dõi</p>
      </div> */}

      <div className="w-full p-1 grid grid-cols-2 gap-2 items-center rounded-md bg-primary-foreground">
